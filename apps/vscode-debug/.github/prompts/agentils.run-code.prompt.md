...
In VS Code, prefer `@agentils` when you need a long-running AgentILS WebView session. The WebView becomes the primary input/output surface once the session starts.
