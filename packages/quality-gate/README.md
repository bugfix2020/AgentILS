...
<p align="center">
  English | <a href="https://github.com/bugfix2020/AgentILS/blob/main/packages/quality-gate/README.zh-CN.md">简体中文</a>
</p>
...
<p align="center">
  <img alt="dry-run pipeline (all steps pass)" src="https://raw.githubusercontent.com/bugfix2020/AgentILS/main/packages/quality-gate/preview/dry-run.gif" width="640">
  <br>
  <em>Dry-run: every step passes; the panel collapses into the green ECAM summary.</em>
</p>

<p align="center">
  <img alt="error pipeline (a step fails, full error output shown below the panel)" src="https://raw.githubusercontent.com/bugfix2020/AgentILS/main/packages/quality-gate/preview/error.gif" width="640">
  <br>
  <em>Failure path: the failing step turns red, the panel shows COMMIT BLOCKED, and the full error output (lint errors with line numbers, file paths, and rule names) is rendered below the panel box.</em>
</p>
